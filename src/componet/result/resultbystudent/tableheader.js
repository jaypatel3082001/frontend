...
//       const qindex = parseInt(counter);
//       const sectionName = `Section ${currentPartPage + 1}`;
//       // setArrrr((prevArrrr) => ({
//       //   ...prevArrrr, // Spread previous state to preserve other properties if any
//       //   sectionId: sectionName, // Assuming sectionName is defined elsewhere
//       //   keyid,
//       //   questions: result.allData.map((index) => ({
//       //     quizeId: index._id,
//       //     quizename: index.quizename,
//       //     questions: index.quizemcqs.map((i) => ({
//       //       questionId: i._id,
//       //       qindex: qindex,
//       //       weightage: i.weightage,
//       //       answer: "", // Initialize answer as empty string
//       //       isAttempted: false, // Set to true if needed in initial state
//       //     })),
//       //   })),
//       // }));
